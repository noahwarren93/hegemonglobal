...
export const HORIZON_EVENTS = [
  ...
  { date: '2026-02-15', name: 'France Municipal Elections (Round 1)', location: 'France', category: 'election', description: 'First round of mayoral elections across French municipalities — key indicator ahead of 2027 presidential race', outcome: 'RN made historic gains in southern municipalities. Macron\'s Renaissance party lost ground in suburban areas. Low turnout at 42%.' },
  { date: '2026-02-22', name: 'France Municipal Elections (Round 2)', location: 'France', category: 'election', description: 'Final round determining new mayors in major French cities with national political implications', outcome: 'RN won mayoral seats in Perpignan, Fréjus, and 6 other cities. Left alliance held Paris, Lyon, Marseille. Major realignment ahead of 2027.' },
  { date: '2026-02-23', name: 'ICC Duterte Confirmation Hearing', location: 'The Hague, Netherlands', category: 'treaty', description: 'International Criminal Court hearing on charges against former Philippine President Rodrigo Duterte', outcome: 'ICC confirmed charges of crimes against humanity for the drug war killings. Duterte remains in Philippines which does not cooperate with ICC.' },
  { date: '2026-03-08', name: 'Colombia Parliamentary Elections', location: 'Bogotá, Colombia', category: 'election', description: 'Election of 188 House members with primaries determining presidential candidates for May vote', outcome: 'Opposition center-right coalition won House majority. Petro\'s allies lost significant ground. Sets stage for contested May presidential election.' },
