...
export const COUNTRIES = {
  // ==================== CATASTROPHIC ====================
  'Ukraine': { lat: 48.38, lng: 31.17, flag: '🇺🇦', risk: 'catastrophic', tags: ['Armed Conflict', 'Territorial Dispute'], region: 'Eastern Europe', pop: '39.5M', gdp: '$191B', leader: 'Volodymyr Zelenskyy', capital: 'Kyiv', currency: 'Ukrainian Hryvnia (UAH)', title: 'War & Peace Talks',
    casualties: {
      total: '~1.8M',
  ...
  'Russia': { lat: 61.52, lng: 105.32, flag: '🇷🇺', risk: 'catastrophic', tags: ['Armed Conflict', 'Sanctions/Isolation', 'Authoritarian Crackdown'], region: 'Eastern Europe', pop: '144M', gdp: '$2.54T', leader: 'Vladimir Putin', capital: 'Moscow', currency: 'Russian Ruble (RUB)', title: 'War & Negotiations',
  ...
  'Palestine': { lat: 31.0, lng: 35.2, flag: '🇵🇸', risk: 'catastrophic', tags: ['Humanitarian Crisis', 'Armed Conflict', 'Terrorism/Insurgency'], region: 'Middle East', pop: '5.3M', gdp: '$20B', leader: 'Mahmoud Abbas (PA) / Hamas (Gaza)', capital: 'Ramallah (de facto)', currency: 'Israeli New Shekel (ILS)', title: 'Post-Ceasefire Crisis',
    analysis: {
  ...
  'Myanmar': { lat: 21.92, lng: 95.96, flag: '🇲🇲', risk: 'catastrophic', tags: ['Civil War', 'Military Junta', 'Humanitarian Crisis'], region: 'Southeast Asia', pop: '54M', gdp: '$65B', leader: 'Min Aung Hlaing (Military Junta)', capital: 'Naypyidaw', currency: 'Myanmar Kyat (MMK)', title: 'Civil War Stalemate',
    casualties: {
      total: '6,000–75,000+',
  ...
  'Yemen': { lat: 15.55, lng: 48.52, flag: '🇾🇪', risk: 'catastrophic', tags: ['Armed Conflict', 'Humanitarian Crisis', 'Sectarian Violence'], region: 'Middle East', pop: '33M', gdp: '$21B', leader: 'Rashad al-Alimi (PLC) / Abdul-Malik al-Houthi (Ansar Allah) — Disputed', capital: 'Sanaa', currency: 'Yemeni Rial (YER)', title: 'Houthi Retaliation Imminent — Red Sea Crisis',
    casualties: {
  ...
  'Haiti': { lat: 18.97, lng: -72.29, flag: '🇭🇹', risk: 'catastrophic', tags: ['Gang Warfare', 'Humanitarian Crisis'], region: 'Caribbean', pop: '11.6M', gdp: '$31B', leader: 'Alix Didier Fils-Aime (Transitional)', capital: 'Port-au-Prince', currency: 'Haitian Gourde (HTG)', title: 'Gang Violence Crisis',
    analysis: {
  ...
  'DRC': { lat: -4.04, lng: 21.76, flag: '🇨🇩', risk: 'catastrophic', tags: ['Armed Conflict', 'Humanitarian Crisis'], region: 'Africa', pop: '113M', gdp: '$65B', leader: 'Félix Tshisekedi', capital: 'Kinshasa', currency: 'Congolese Franc (CDF)', title: 'M23 Occupation Crisis',
    analysis: {
  ...
  'Somalia': { lat: 5.15, lng: 46.20, flag: '🇸🇴', risk: 'extreme', tags: ['Terrorism/Insurgency', 'Humanitarian Crisis'], region: 'Africa', pop: '18M', gdp: '$8B', leader: 'Hassan Sheikh Mohamud', capital: 'Mogadishu', currency: 'Somali Shilling (SOS)', title: 'Al-Shabaab Threat',
    analysis: {
  ...
  // ==================== EXTREME ====================
  'Israel': { lat: 32.8, lng: 34.8, flag: '🇮🇱', risk: 'catastrophic', tags: ['Armed Conflict', 'Territorial Dispute', 'Active Military Operations'], region: 'Middle East', pop: '9.5M', gdp: '$611B', leader: 'Benjamin Netanyahu', capital: 'Jerusalem (de facto)', currency: 'Israeli New Shekel (ILS)', title: 'Active War — Multi-Front Conflict',
  ...
  'Taiwan': { lat: 23.70, lng: 120.96, flag: '🇹🇼', risk: 'extreme', tags: ['Territorial Dispute', 'Military Threat'], region: 'East Asia', pop: '24M', gdp: '$884B', leader: 'Lai Ching-te', capital: 'Taipei', currency: 'New Taiwan Dollar (TWD)', title: 'Cross-Strait Tensions',
    analysis: {
  ...
  'Iran': { lat: 32.43, lng: 53.69, flag: '🇮🇷', risk: 'catastrophic', tags: ['Armed Conflict', 'Sanctions/Isolation', 'Nuclear Threat'], region: 'Middle East', pop: '87M', gdp: '$388B', leader: 'Mojtaba Khamenei', capital: 'Tehran', currency: 'Iranian Rial (IRR)', title: 'Active War — Multi-Front Conflict',
    casualties: {
      total: '1,190+',
  ...
  'North Korea': { lat: 40.34, lng: 127.51, flag: '🇰🇵', risk: 'extreme', tags: ['Nuclear Threat', 'Sanctions/Isolation', 'Authoritarian Crackdown'], region: 'East Asia', pop: '26M', gdp: '$18B', leader: 'Kim Jong Un', capital: 'Pyongyang', currency: 'North Korean Won (KPW)', title: 'Nuclear Threats',
  ...
  'Syria': { lat: 34.80, lng: 38.99, flag: '🇸🇾', risk: 'extreme', tags: ['Armed Conflict', 'Humanitarian Crisis'], region: 'Middle East', pop: '22M', gdp: '$9B', leader: 'Ahmad al-Sharaa', capital: 'Damascus', currency: 'Syrian Pound (SYP)', title: 'Post-Assad Transition',
    analysis: {
  ...
  'Lebanon': { lat: 34.2, lng: 35.8, flag: '🇱🇧', risk: 'catastrophic', tags: ['Armed Conflict', 'Political Instability', 'Sectarian Violence'], region: 'Middle East', pop: '5.5M', gdp: '$22B', leader: 'Joseph Aoun', capital: 'Beirut', currency: 'Lebanese Pound (LBP)', title: 'Under Attack — Israel Ground Invasion Authorized',
    analysis: {
  ...
  'Mali': { lat: 17.57, lng: -4.00, flag: '🇲🇱', risk: 'extreme', tags: ['Military Junta', 'Terrorism/Insurgency'], region: 'Africa', pop: '22M', gdp: '$19B', leader: 'Assimi Goita (Military Junta)', capital: 'Bamako', currency: 'West African CFA Franc (XOF)', title: 'Wagner/Jihadi Conflict',
    analysis: {
  ...
  'Burkina Faso': { lat: 12.24, lng: -1.56, flag: '🇧🇫', risk: 'extreme', tags: ['Military Junta', 'Terrorism/Insurgency'], region: 'Africa', pop: '22M', gdp: '$19B', leader: 'Ibrahim Traoré', capital: 'Ouagadougou', currency: 'West African CFA Franc (XOF)', title: 'Jihadi Violence',
    analysis: {
  ...
  'Niger': { lat: 17.61, lng: 8.08, flag: '🇳🇪', risk: 'extreme', tags: ['Military Junta', 'Coup/Transition'], region: 'Africa', pop: '26M', gdp: '$15B', leader: 'Abdourahamane Tchiani (Military Junta)', capital: 'Niamey', currency: 'West African CFA Franc (XOF)', title: 'Coup Government',
    analysis: {
  ...
  // ==================== SEVERE ====================
  'China': { lat: 35.86, lng: 104.20, flag: '🇨🇳', risk: 'stormy', tags: ['Authoritarian Crackdown', 'Territorial Dispute'], region: 'East Asia', pop: '1.4B', gdp: '$19.4T', leader: 'Xi Jinping', capital: 'Beijing', currency: 'Chinese Yuan Renminbi (CNY)', title: 'Economic Slowdown',
  ...
  'Venezuela': { lat: 6.42, lng: -66.59, flag: '🇻🇪', risk: 'extreme', tags: ['Authoritarian Crackdown', 'Economic Crisis'], region: 'South America', pop: '28M', gdp: '$92B', leader: 'Delcy Rodríguez (Acting)', capital: 'Caracas', currency: 'Venezuelan Bolivar (VES)', title: 'Post-Maduro Transition',
    analysis: {
  ...
  'Pakistan': { lat: 30.38, lng: 69.35, flag: '🇵🇰', risk: 'catastrophic', tags: ['Armed Conflict', 'Terrorism/Insurgency'], region: 'South Asia', pop: '255M', gdp: '$411B', leader: 'Shehbaz Sharif', capital: 'Islamabad', currency: 'Pakistani Rupee (PKR)', title: 'Active War — Afghanistan Conflict',
  ...
  'Bangladesh': { lat: 23.68, lng: 90.36, flag: '🇧🇩', risk: 'stormy', tags: ['Political Instability'], region: 'South Asia', pop: '170M', gdp: '$460B', leader: 'Tarique Rahman', capital: 'Dhaka', currency: 'Bangladeshi Taka (BDT)', title: 'New Government',
    analysis: {
  ...
  'Turkey': { lat: 38.96, lng: 35.24, flag: '🇹🇷', risk: 'stormy', tags: ['Political Instability'], region: 'Middle East', pop: '85M', gdp: '$1.57T', leader: 'Recep Tayyip Erdogan', capital: 'Ankara', currency: 'Turkish Lira (TRY)', title: 'Economic Crisis',
    analysis: {
  ...
  'Egypt': { lat: 26.82, lng: 30.80, flag: '🇪🇬', risk: 'severe', tags: ['Authoritarian Crackdown', 'Economic Crisis'], region: 'North Africa', pop: '105M', gdp: '$387B', leader: 'Abdel Fattah el-Sisi', capital: 'Cairo', currency: 'Egyptian Pound (EGP)', title: 'Economic Crisis',
    analysis: {
  ...
  'Argentina': { lat: -38.42, lng: -63.62, flag: '🇦🇷', risk: 'stormy', tags: ['Economic Crisis'], region: 'South America', pop: '46M', gdp: '$641B', leader: 'Javier Milei', capital: 'Buenos Aires', currency: 'Argentine Peso (ARS)', title: 'Economic Crisis',
    analysis: {
  ...
  'Nigeria': { lat: 9.08, lng: 8.68, flag: '🇳🇬', risk: 'severe', tags: ['Terrorism/Insurgency', 'Sectarian Violence'], region: 'Africa', pop: '237M', gdp: '$285B', leader: 'Bola Tinubu', capital: 'Abuja', currency: 'Nigerian Naira (NGN)', title: 'Security Crisis',
    analysis: {
  ...
  'Ethiopia': { lat: 9.15, lng: 40.49, flag: '🇪🇹', risk: 'severe', tags: ['Sectarian Violence', 'Humanitarian Crisis'], region: 'Africa', pop: '136M', gdp: '$126B', leader: 'Abiy Ahmed', capital: 'Addis Ababa', currency: 'Ethiopian Birr (ETB)', title: 'Post-War Tensions',
    analysis: {
  ...
  'Iraq': { lat: 33.22, lng: 43.68, flag: '🇮🇶', risk: 'extreme', tags: ['Terrorism/Insurgency', 'Sectarian Violence', 'Political Instability'], region: 'Middle East', pop: '44M', gdp: '$270B', leader: 'Mohammed al-Sudani', capital: 'Baghdad', currency: 'Iraqi Dinar (IQD)', title: 'Under Iranian Retaliatory Fire',
    analysis: {
  ...
  'Libya': { lat: 26.34, lng: 17.23, flag: '🇱🇾', risk: 'severe', tags: ['Political Instability', 'Armed Conflict'], region: 'North Africa', pop: '7M', gdp: '$41B', leader: 'Abdul Hamid Dbeibah (Tripoli) / Osama Hammad (Benghazi) — Divided', capital: 'Tripoli', currency: 'Libyan Dinar (LYD)', title: 'Civil Conflict',
    analysis: {
  ...
  'Algeria': { lat: 28.03, lng: 1.66, flag: '🇩🇿', risk: 'stormy', tags: ['Political Instability'], region: 'North Africa', pop: '45M', gdp: '$190B', leader: 'Abdelmadjid Tebboune', capital: 'Algiers', currency: 'Algerian Dinar (DZD)', title: 'Post-Bouteflika Era',
    analysis: {
  ...
  'Tunisia': { lat: 33.89, lng: 9.54, flag: '🇹🇳', risk: 'stormy', tags: ['Political Instability', 'Economic Crisis'], region: 'North Africa', pop: '12M', gdp: '$47B', leader: 'Kais Saied', capital: 'Tunis', currency: 'Tunisian Dinar (TND)', title: 'Democratic Backsliding',
    analysis: {
  ...
  'Ecuador': { lat: -1.83, lng: -78.18, flag: '🇪🇨', risk: 'severe', tags: ['Gang Warfare', 'Political Instability'], region: 'South America', pop: '18M', gdp: '$107B', leader: 'Daniel Noboa', capital: 'Quito', currency: 'US Dollar (USD)', title: 'Gang Violence Surge',
    analysis: {
  ...
  'Georgia': { lat: 42.32, lng: 43.36, flag: '🇬🇪', risk: 'stormy', tags: ['Political Instability'], region: 'Caucasus', pop: '3.7M', gdp: '$25B', leader: 'Mikheil Kavelashvili', capital: 'Tbilisi', currency: 'Georgian Lari (GEL)', title: 'Pro-Russia Turn',
    analysis: {
  ...
  'Armenia': { lat: 40.07, lng: 45.04, flag: '🇦🇲', risk: 'stormy', tags: ['Territorial Dispute'], region: 'Caucasus', pop: '2.8M', gdp: '$20B', leader: 'Nikol Pashinyan', capital: 'Yerevan', currency: 'Armenian Dram (AMD)', title: 'Post-Karabakh Crisis',
    analysis: {
  ...
  'Belarus': { lat: 53.71, lng: 27.95, flag: '🇧🇾', risk: 'severe', tags: ['Authoritarian Crackdown', 'Sanctions/Isolation'], region: 'Eastern Europe', pop: '9M', gdp: '$73B', leader: 'Alexander Lukashenko', capital: 'Minsk', currency: 'Belarusian Ruble (BYN)', title: 'Russian Ally',
    analysis: {
  ...
  'Moldova': { lat: 47.41, lng: 28.37, flag: '🇲🇩', risk: 'stormy', tags: ['Political Instability', 'Territorial Dispute'], region: 'Eastern Europe', pop: '2.6M', gdp: '$15B', leader: 'Maia Sandu', capital: 'Chisinau', currency: 'Moldovan Leu (MDL)', title: 'Russia Pressure',
    analysis: {
  ...
  'Cuba': { lat: 21.52, lng: -77.78, flag: '🇨🇺', risk: 'extreme', tags: ['Sanctions/Isolation', 'Authoritarian Crackdown', 'Economic Crisis'], region: 'Caribbean', pop: '11M', gdp: '$27B', leader: 'Miguel Diaz-Canel', capital: 'Havana', currency: 'Cuban Peso (CUP)', title: 'Escalating Crisis & US Tensions',
    analysis: {
  ...
  'Nicaragua': { lat: 12.87, lng: -85.21, flag: '🇳🇮', risk: 'severe', tags: ['Authoritarian Crackdown'], region: 'Central America', pop: '7M', gdp: '$15B', leader: 'Daniel Ortega', capital: 'Managua', currency: 'Nicaraguan Cordoba (NIO)', title: 'Authoritarian Rule',
    analysis: {
  ...
  // STORMY COUNTRIES
  'United States': { lat: 37.09, lng: -95.71, flag: '🇺🇸', risk: 'stormy', tags: ['Political Instability', 'Active Military Operations'], region: 'North America', pop: '335M', gdp: '$30.6T', leader: 'Donald Trump', capital: 'Washington, D.C.', currency: 'US Dollar (USD)', title: 'Active Military Strikes on Iran & Extreme Political Polarization',
  ...
  'France': { lat: 46.23, lng: 2.21, flag: '🇫🇷', risk: 'cloudy', tags: [], region: 'Western Europe', pop: '68M', gdp: '$3.4T', leader: 'Emmanuel Macron', capital: 'Paris', currency: 'Euro (EUR)', title: 'Political Fragmentation',
  ...
  'Germany': { lat: 51.17, lng: 10.45, flag: '🇩🇪', risk: 'cloudy', tags: [], region: 'Western Europe', pop: '84M', gdp: '$5.0T', leader: 'Friedrich Merz', capital: 'Berlin', currency: 'Euro (EUR)', title: 'New Government',
    analysis: {
  ...
  'Brazil': { lat: -14.24, lng: -51.93, flag: '🇧🇷', risk: 'clear', tags: [], region: 'South America', pop: '215M', gdp: '$2.26T', leader: 'Lula da Silva', capital: 'Brasilia', currency: 'Brazilian Real (BRL)', title: 'Amazon & Politics',
    analysis: {
  ...
  'Mexico': { lat: 23.63, lng: -102.55, flag: '🇲🇽', risk: 'severe', tags: ['Gang Warfare'], region: 'North America', pop: '130M', gdp: '$1.86T', leader: 'Claudia Sheinbaum', capital: 'Mexico City', currency: 'Mexican Peso (MXN)', title: 'Cartel Violence',
    analysis: {
  ...
  'India': { lat: 22.0, lng: 79.0, flag: '🇮🇳', risk: 'cloudy', tags: ['Sectarian Violence'], region: 'South Asia', pop: '1.4B', gdp: '$4.13T', leader: 'Narendra Modi', capital: 'New Delhi', currency: 'Indian Rupee (INR)', title: 'Rising Power',
  ...
  'South Korea': { lat: 35.91, lng: 127.77, flag: '🇰🇷', risk: 'cloudy', tags: ['Political Instability'], region: 'East Asia', pop: '52M', gdp: '$1.87T', leader: 'Lee Jae-myung', capital: 'Seoul', currency: 'South Korean Won (KRW)', title: 'Post-Crisis Recovery',
    analysis: {
  ...
  'Saudi Arabia': { lat: 23.89, lng: 45.08, flag: '🇸🇦', risk: 'severe', tags: ['Authoritarian Crackdown', 'Proximity to Conflict'], region: 'Middle East', pop: '36M', gdp: '$1.27T', leader: 'Mohammed bin Salman', capital: 'Riyadh', currency: 'Saudi Riyal (SAR)', title: 'Under Iranian Retaliatory Strike',
    analysis: {
  ...
  'South Africa': { lat: -30.56, lng: 22.94, flag: '🇿🇦', risk: 'stormy', tags: ['Economic Crisis'], region: 'Africa', pop: '60M', gdp: '$399B', leader: 'Cyril Ramaphosa', capital: 'Pretoria', currency: 'South African Rand (ZAR)', title: 'Coalition Government',
    analysis: {
  ...
  'Kenya': { lat: -0.02, lng: 37.91, flag: '🇰🇪', risk: 'stormy', tags: ['Political Instability'], region: 'Africa', pop: '54M', gdp: '$113B', leader: 'William Ruto', capital: 'Nairobi', currency: 'Kenyan Shilling (KES)', title: 'Protests & Debt',
    analysis: {
  ...
  'Colombia': { lat: 4.0, lng: -72.9, flag: '🇨🇴', risk: 'severe', tags: ['Gang Warfare'], region: 'South America', pop: '52M', gdp: '$438B', leader: 'Gustavo Petro', capital: 'Bogota', currency: 'Colombian Peso (COP)', title: 'Peace Process',
    analysis: {
  ...
  'Peru': { lat: -9.19, lng: -75.02, flag: '🇵🇪', risk: 'stormy', tags: ['Political Instability'], region: 'South America', pop: '34M', gdp: '$318B', leader: 'José María Balcázar (Interim)', capital: 'Lima', currency: 'Peruvian Sol (PEN)', title: 'Political Instability',
    analysis: {
  ...
  'Thailand': { lat: 15.87, lng: 100.99, flag: '🇹🇭', risk: 'stormy', tags: ['Political Instability'], region: 'Southeast Asia', pop: '70M', gdp: '$495B', leader: 'Anutin Charnvirakul', capital: 'Bangkok', currency: 'Thai Baht (THB)', title: 'Political Uncertainty',
    analysis: {
  ...
  'Philippines': { lat: 12.88, lng: 121.77, flag: '🇵🇭', risk: 'stormy', tags: ['Terrorism/Insurgency'], region: 'Southeast Asia', pop: '115M', gdp: '$494B', leader: 'Ferdinand Marcos Jr.', capital: 'Manila', currency: 'Philippine Peso (PHP)', title: 'China Tensions',
    analysis: {
  ...
  'Hungary': { lat: 47.16, lng: 19.50, flag: '🇭🇺', risk: 'cloudy', tags: ['Political Instability'], region: 'Eastern Europe', pop: '10M', gdp: '$188B', leader: 'Viktor Orbán', capital: 'Budapest', currency: 'Hungarian Forint (HUF)', title: 'Democratic Backsliding',
    analysis: {
  ...
  'Serbia': { lat: 44.02, lng: 21.01, flag: '🇷🇸', risk: 'cloudy', tags: [], region: 'Balkans', pop: '7M', gdp: '$63B', leader: 'Aleksandar Vučić', capital: 'Belgrade', currency: 'Serbian Dinar (RSD)', title: 'Kosovo Tensions',
    analysis: {
  ...
  'El Salvador': { lat: 13.79, lng: -88.90, flag: '🇸🇻', risk: 'stormy', tags: ['Authoritarian Crackdown'], region: 'Central America', pop: '6.5M', gdp: '$33B', leader: 'Nayib Bukele', capital: 'San Salvador', currency: 'US Dollar (USD)', title: 'Gang Crackdown',
    analysis: {
  ...
  'Sri Lanka': { lat: 7.87, lng: 80.77, flag: '🇱🇰', risk: 'stormy', tags: ['Political Instability'], region: 'South Asia', pop: '22M', gdp: '$75B', leader: 'Anura Kumara', capital: 'Sri Jayawardenepura Kotte', currency: 'Sri Lankan Rupee (LKR)', title: 'Economic Recovery',
    analysis: {
  ...
  'Bolivia': { lat: -16.29, lng: -63.59, flag: '🇧🇴', risk: 'stormy', tags: ['Political Instability'], region: 'South America', pop: '12M', gdp: '$44B', leader: 'Rodrigo Paz Pereira', capital: 'Sucre', currency: 'Bolivian Boliviano (BOB)', title: 'New Presidency',
    analysis: {
  ...
  'Guyana': { lat: 4.86, lng: -58.93, flag: '🇬🇾', risk: 'stormy', tags: ['Territorial Dispute'], region: 'South America', pop: '0.8M', gdp: '$15B', leader: 'Irfaan Ali', capital: 'Georgetown', currency: 'Guyanese Dollar (GYD)', title: 'Oil Boom',
    analysis: {
  ...
  // ==================== CLOUDY COUNTRIES ====================
  'United Kingdom': { lat: 54.0, lng: -2.5, flag: '🇬🇧', risk: 'cloudy', tags: [], region: 'Western Europe', pop: '67M', gdp: '$3.96T', leader: 'Keir Starmer', capital: 'London', currency: 'Pound Sterling (GBP)', title: 'Post-Brexit Adjustment',
  ...
  'Italy': { lat: 41.87, lng: 12.57, flag: '🇮🇹', risk: 'cloudy', tags: [], region: 'Western Europe', pop: '59M', gdp: '$2.54T', leader: 'Giorgia Meloni', capital: 'Rome', currency: 'Euro (EUR)', title: 'Right-Wing Government',
    analysis: {
  ...
  'Poland': { lat: 51.92, lng: 19.15, flag: '🇵🇱', risk: 'cloudy', tags: [], region: 'Eastern Europe', pop: '38M', gdp: '$688B', leader: 'Donald Tusk', capital: 'Warsaw', currency: 'Polish Zloty (PLN)', title: 'Democratic Recovery',
    analysis: {
  ...
  'Spain': { lat: 40.46, lng: -3.75, flag: '🇪🇸', risk: 'cloudy', tags: [], region: 'Western Europe', pop: '48M', gdp: '$1.4T', leader: 'Pedro Sánchez', capital: 'Madrid', currency: 'Euro (EUR)', title: 'Coalition Politics',
    analysis: {
  ...
  'Netherlands': { lat: 52.13, lng: 5.29, flag: '🇳🇱', risk: 'cloudy', tags: [], region: 'Western Europe', pop: '18M', gdp: '$991B', leader: 'Rob Jetten', capital: 'Amsterdam', currency: 'Euro (EUR)', title: 'Right-Wing Shift',
    analysis: {
  ...
  'Indonesia': { lat: -0.79, lng: 113.92, flag: '🇮🇩', risk: 'cloudy', tags: [], region: 'Southeast Asia', pop: '277M', gdp: '$1.3T', leader: 'Prabowo Subianto', capital: 'Jakarta', currency: 'Indonesian Rupiah (IDR)', title: 'New Leadership',
    analysis: {
  ...
  'Vietnam': { lat: 21.0, lng: 105.8, flag: '🇻🇳', risk: 'cloudy', tags: [], region: 'Southeast Asia', pop: '100M', gdp: '$485B', leader: 'Tô Lâm', capital: 'Hanoi', currency: 'Vietnamese Dong (VND)', title: 'Manufacturing Hub',
    analysis: {
  ...
  'Japan': { lat: 36.20, lng: 138.25, flag: '🇯🇵', risk: 'clear', tags: [], region: 'East Asia', pop: '125M', gdp: '$4.2T', leader: 'Sanae Takaichi', capital: 'Tokyo', currency: 'Japanese Yen (JPY)', title: 'Defense Buildup',
    analysis: {
  ...
  'Canada': { lat: 61.0, lng: -98.0, flag: '🇨🇦', risk: 'clear', tags: [], region: 'North America', pop: '40M', gdp: '$2.1T', leader: 'Mark Carney', capital: 'Ottawa', currency: 'Canadian Dollar (CAD)', title: 'Stable Democracy',
    analysis: {
  ...
  'Australia': { lat: -25.27, lng: 133.78, flag: '🇦🇺', risk: 'clear', tags: [], region: 'Oceania', pop: '26M', gdp: '$1.7T', leader: 'Anthony Albanese', capital: 'Canberra', currency: 'Australian Dollar (AUD)', title: 'AUKUS Partner',
    analysis: {
  ...
  'Singapore': { lat: 1.35, lng: 103.82, flag: '🇸🇬', risk: 'clear', tags: [], region: 'Southeast Asia', pop: '6M', gdp: '$574B', leader: 'Lawrence Wong', capital: 'Singapore', currency: 'Singapore Dollar (SGD)', title: 'Leadership Transition',
    analysis: {
  ...
  'UAE': { lat: 23.42, lng: 53.85, flag: '🇦🇪', risk: 'severe', tags: ['Proximity to Conflict'], region: 'Middle East', pop: '10M', gdp: '$509B', leader: 'Mohamed bin Zayed Al Nahyan', capital: 'Abu Dhabi', currency: 'UAE Dirham (AED)', title: 'Iranian Strikes Reported',
    analysis: {
  ...
  'Switzerland': { lat: 46.82, lng: 8.23, flag: '🇨🇭', risk: 'clear', tags: [], region: 'Western Europe', pop: '9M', gdp: '$808B', leader: 'Karin Keller-Sutter (Federal Council)', capital: 'Bern', currency: 'Swiss Franc (CHF)', title: 'Neutral & Stable',
    analysis: {
  ...
  'Norway': { lat: 64.5, lng: 14.0, flag: '🇳🇴', risk: 'clear', tags: [], region: 'Northern Europe', pop: '5M', gdp: '$579B', leader: 'Jonas Gahr Store', capital: 'Oslo', currency: 'Norwegian Krone (NOK)', title: 'Energy Superpower',
    analysis: {
  ...
  'Malaysia': { lat: 4.21, lng: 101.98, flag: '🇲🇾', risk: 'cloudy', tags: [], region: 'Southeast Asia', pop: '34M', gdp: '$407B', leader: 'Anwar Ibrahim', capital: 'Kuala Lumpur', currency: 'Malaysian Ringgit (MYR)', title: 'Coalition Politics',
    analysis: {
  ...
  'Romania': { lat: 45.94, lng: 24.97, flag: '🇷🇴', risk: 'cloudy', tags: [], region: 'Eastern Europe', pop: '19M', gdp: '$301B', leader: 'Nicusor Dan', capital: 'Bucharest', currency: 'Romanian Leu (RON)', title: 'NATO Frontline',
    analysis: {
  ...
  'Greece': { lat: 39.07, lng: 21.82, flag: '🇬🇷', risk: 'cloudy', tags: [], region: 'Southern Europe', pop: '10M', gdp: '$219B', leader: 'Kyriakos Mitsotakis', capital: 'Athens', currency: 'Euro (EUR)', title: 'Economic Recovery',
    analysis: {
  ...
  'Sweden': { lat: 62.5, lng: 16.0, flag: '🇸🇪', risk: 'cloudy', tags: [], region: 'Northern Europe', pop: '10M', gdp: '$585B', leader: 'Ulf Kristersson', capital: 'Stockholm', currency: 'Swedish Krona (SEK)', title: 'NATO Member',
    analysis: {
  ...
  'Finland': { lat: 61.92, lng: 25.75, flag: '🇫🇮', risk: 'cloudy', tags: [], region: 'Northern Europe', pop: '6M', gdp: '$281B', leader: 'Petteri Orpo', capital: 'Helsinki', currency: 'Euro (EUR)', title: 'New NATO Member',
    analysis: {
  ...
  'Austria': { lat: 47.52, lng: 14.55, flag: '🇦🇹', risk: 'cloudy', tags: [], region: 'Western Europe', pop: '9M', gdp: '$471B', leader: 'Christian Stocker', capital: 'Vienna', currency: 'Euro (EUR)', title: 'Three-Party Coalition',
    analysis: {
  ...
  'Azerbaijan': { lat: 40.14, lng: 47.58, flag: '🇦🇿', risk: 'stormy', tags: ['Post-Conflict', 'Energy State'], region: 'Caucasus', pop: '10M', gdp: '$78B', leader: 'Ilham Aliyev', capital: 'Baku', currency: 'Azerbaijani Manat (AZN)', title: 'Post-Karabakh Consolidation',
    analysis: {
  ...
  'Chile': { lat: -30.0, lng: -71.0, flag: '🇨🇱', risk: 'cloudy', tags: [], region: 'South America', pop: '19M', gdp: '$301B', leader: 'Jose Antonio Kast', capital: 'Santiago', currency: 'Chilean Peso (CLP)', title: 'Presidential Transition',
    analysis: {
  ...
  'Morocco': { lat: 31.79, lng: -7.09, flag: '🇲🇦', risk: 'cloudy', tags: ['Territorial Dispute'], region: 'North Africa', pop: '37M', gdp: '$132B', leader: 'King Mohammed VI', capital: 'Rabat', currency: 'Moroccan Dirham (MAD)', title: 'Western Sahara',
    analysis: {
  ...
  'Western Sahara': { lat: 24.22, lng: -12.89, flag: '🇪🇭', risk: 'stormy', tags: ['Territorial Dispute', 'Occupation'], region: 'North Africa', pop: '600K', gdp: '$1B', leader: 'Disputed (Morocco administers / SADR president Brahim Ghali)', capital: 'Laayoune', currency: 'Moroccan Dirham (MAD)', title: 'Disputed Territory',
    analysis: {
  ...
  'Senegal': { lat: 14.50, lng: -14.45, flag: '🇸🇳', risk: 'cloudy', tags: [], region: 'Africa', pop: '18M', gdp: '$28B', leader: 'Bassirou Faye', capital: 'Dakar', currency: 'West African CFA Franc (XOF)', title: 'Democratic Transition',
    analysis: {
  ...
  'Tanzania': { lat: -6.37, lng: 34.89, flag: '🇹🇿', risk: 'cloudy', tags: [], region: 'Africa', pop: '65M', gdp: '$76B', leader: 'Samia Suluhu Hassan', capital: 'Dodoma', currency: 'Tanzanian Shilling (TZS)', title: 'Stable Growth',
    analysis: {
  ...
  'New Zealand': { lat: -41.5, lng: 172.5, flag: '🇳🇿', risk: 'clear', tags: [], region: 'Oceania', pop: '5M', gdp: '$247B', leader: 'Christopher Luxon', capital: 'Wellington', currency: 'New Zealand Dollar (NZD)', title: 'Stable',
    analysis: {
  ...
  'Denmark': { lat: 56.26, lng: 9.50, flag: '🇩🇰', risk: 'clear', tags: [], region: 'Northern Europe', pop: '6M', gdp: '$395B', leader: 'Mette Frederiksen', capital: 'Copenhagen', currency: 'Danish Krone (DKK)', title: 'Greenland Focus',
    analysis: {
  ...
  'Greenland': { lat: 71.71, lng: -42.60, flag: '🇬🇱', risk: 'stormy', tags: ['Territorial Dispute'], region: 'Arctic / North Atlantic', pop: '57K', gdp: '$3.1B', leader: 'Múte B. Egede', capital: 'Nuuk', currency: 'Danish Krone (DKK)', title: 'Arctic Sovereignty Dispute',
    analysis: {
  ...
  'Ireland': { lat: 53.14, lng: -7.69, flag: '🇮🇪', risk: 'clear', tags: [], region: 'Western Europe', pop: '5M', gdp: '$533B', leader: 'Simon Harris', capital: 'Dublin', currency: 'Euro (EUR)', title: 'Tech Hub',
    analysis: {
  ...
  'Portugal': { lat: 39.40, lng: -8.22, flag: '🇵🇹', risk: 'clear', tags: [], region: 'Western Europe', pop: '10M', gdp: '$252B', leader: 'Luís Montenegro', capital: 'Lisbon', currency: 'Euro (EUR)', title: 'Stable',
    analysis: {
  ...
  'Qatar': { lat: 25.35, lng: 51.18, flag: '🇶🇦', risk: 'cloudy', tags: [], region: 'Middle East', pop: '3M', gdp: '$221B', leader: 'Sheikh Tamim bin Hamad Al Thani', capital: 'Doha', currency: 'Qatari Riyal (QAR)', title: 'Al Udeid Targeted by Iran',
    analysis: {
  ...
  'Costa Rica': { lat: 9.75, lng: -83.75, flag: '🇨🇷', risk: 'clear', tags: [], region: 'Central America', pop: '5M', gdp: '$69B', leader: 'Rodrigo Chaves', capital: 'San Jose', currency: 'Costa Rican Colon (CRC)', title: 'Stable Democracy',
    analysis: {
  ...
  'Uruguay': { lat: -32.52, lng: -55.77, flag: '🇺🇾', risk: 'clear', tags: [], region: 'South America', pop: '3.5M', gdp: '$71B', leader: 'Yamandú Orsi', capital: 'Montevideo', currency: 'Uruguayan Peso (UYU)', title: 'Stable Democracy',
    analysis: {
  ...
  'Botswana': { lat: -22.33, lng: 24.68, flag: '🇧🇼', risk: 'clear', tags: [], region: 'Africa', pop: '2.6M', gdp: '$19B', leader: 'Duma Boko', capital: 'Gaborone', currency: 'Botswana Pula (BWP)', title: 'Stable Democracy',
    analysis: {
  ...
  'Estonia': { lat: 58.60, lng: 25.01, flag: '🇪🇪', risk: 'cloudy', tags: [], region: 'Baltic', pop: '1.4M', gdp: '$38B', leader: 'Kristen Michal', capital: 'Tallinn', currency: 'Euro (EUR)', title: 'Digital Pioneer',
    analysis: {
  ...
  'Latvia': { lat: 56.88, lng: 24.60, flag: '🇱🇻', risk: 'cloudy', tags: [], region: 'Baltic', pop: '1.9M', gdp: '$41B', leader: 'Evika Siliņa', capital: 'Riga', currency: 'Euro (EUR)', title: 'NATO Frontline',
    analysis: {
  ...
  'Lithuania': { lat: 55.17, lng: 23.88, flag: '🇱🇹', risk: 'cloudy', tags: [], region: 'Baltic', pop: '2.8M', gdp: '$70B', leader: 'Inga Ruginiene', capital: 'Vilnius', currency: 'Euro (EUR)', title: 'Belarus Border',
    analysis: {
  ...
  'Czech Republic': { lat: 49.82, lng: 15.47, flag: '🇨🇿', risk: 'clear', tags: [], region: 'Eastern Europe', pop: '10M', gdp: '$290B', leader: 'Andrej Babiš', capital: 'Prague', currency: 'Czech Koruna (CZK)', title: 'Stable',
    analysis: {
  ...
  'Belgium': { lat: 50.50, lng: 4.47, flag: '🇧🇪', risk: 'clear', tags: [], region: 'Western Europe', pop: '12M', gdp: '$582B', leader: 'Bart De Wever', capital: 'Brussels', currency: 'Euro (EUR)', title: 'EU Capital',
    analysis: {
  ...
  'Croatia': { lat: 44.5, lng: 16.0, flag: '🇭🇷', risk: 'clear', tags: [], region: 'Southern Europe', pop: '4M', gdp: '$71B', leader: 'Andrej Plenković', capital: 'Zagreb', currency: 'Euro (EUR)', title: 'Eurozone Member',
    analysis: {
  ...
  'Slovenia': { lat: 46.15, lng: 14.99, flag: '🇸🇮', risk: 'clear', tags: [], region: 'Southern Europe', pop: '2M', gdp: '$62B', leader: 'Robert Golob', capital: 'Ljubljana', currency: 'Euro (EUR)', title: 'Stable',
    analysis: {
  ...
  'Luxembourg': { lat: 49.82, lng: 6.13, flag: '🇱🇺', risk: 'clear', tags: [], region: 'Western Europe', pop: '0.7M', gdp: '$87B', leader: 'Luc Frieden', capital: 'Luxembourg City', currency: 'Euro (EUR)', title: 'Financial Hub',
    analysis: {
  ...
  'Oman': { lat: 21.47, lng: 55.98, flag: '🇴🇲', risk: 'cloudy', tags: [], region: 'Middle East', pop: '5M', gdp: '$104B', leader: 'Sultan Haitham bin Tariq', capital: 'Muscat', currency: 'Omani Rial (OMR)', title: 'Neutral Mediator',
    analysis: {
  ...
  'Iceland': { lat: 64.96, lng: -19.02, flag: '🇮🇸', risk: 'clear', tags: [], region: 'Northern Europe', pop: '0.4M', gdp: '$27B', leader: 'Kristrun Frostadottir', capital: 'Reykjavik', currency: 'Icelandic Krona (ISK)', title: 'Volcanic Activity',
    analysis: {
  ...
  'Malta': { lat: 35.94, lng: 14.38, flag: '🇲🇹', risk: 'clear', tags: [], region: 'Mediterranean', pop: '0.5M', gdp: '$18B', leader: 'Robert Abela', capital: 'Valletta', currency: 'Euro (EUR)', title: 'Stable',
    analysis: {
  ...
  'Mongolia': { lat: 46.86, lng: 103.85, flag: '🇲🇳', risk: 'clear', tags: [], region: 'East Asia', pop: '3.4M', gdp: '$17B', leader: 'Ukhnaa Khurelsukh', capital: 'Ulaanbaatar', currency: 'Mongolian Tugrik (MNT)', title: 'Stable Democracy',
    analysis: {
...
export const RECENT_ELECTIONS = [
  ...
  { flag: '🇧🇩', country: 'Bangladesh', date: 'Feb 2026', type: 'General Election & Referendum', winner: 'Tarique Rahman - BNP (Center-Right)', result: 'BNP wins 209/297 declared seats. ~59.5% turnout.', summary: 'First election since the 2024 July Revolution ousted Sheikh Hasina. July Charter referendum passes with ~62.7% approval.',
    parties: [
      { name: 'BNP (Bangladesh Nationalist Party)', seats: '209/297', pct: '~48%', desc: 'Center-right party led by Tarique Rahman from exile. Advocates free-market economics, closer ties with the West and China, and democratic governance. Won a commanding majority on an anti-corruption, economic reform platform. BNP-led alliance won 212 seats total.' },
      { name: 'Jamaat-e-Islami', seats: '68/297', pct: '~19%', desc: 'Islamist conservative party that served as the main opposition bloc. Supports Sharia-influenced governance, social conservatism, and was a key ally in the July Revolution that toppled Hasina.' },
  ...
  { flag: '🇵🇹', country: 'Portugal', date: 'Jan–Feb 2026', type: 'Presidential Election', winner: 'Antonio Jose Seguro - PS (Center-Left)', result: 'Seguro wins runoff ~66.7% to ~33.3% over Ventura (Chega).', summary: 'Socialist candidate defeats right-wing populist challenger in decisive runoff after close first round.',
    parties: [
      { name: 'PS (Socialist Party) - Antonio Jose Seguro', seats: 'President', pct: '~66.7%', desc: 'Center-left party. Seguro is a veteran politician and former PS leader who advocates European integration, social cohesion, and institutional stability. Won decisively in the runoff as voters rallied against the populist right.' },
      { name: 'Chega (Enough) - Andre Ventura', seats: 'Runner-up', pct: '~33.3%', desc: 'Right-wing populist party. Anti-immigration, anti-corruption rhetoric, calls for tougher law enforcement. Made it to the runoff for the first time but was defeated by a wide margin as other parties\' voters consolidated behind Seguro.' },
    ],
  ...
  { flag: '🇯🇵', country: 'Japan', date: 'Feb 2026', type: 'Snap Election', winner: 'Sanae Takaichi - LDP (Right Wing)', result: 'LDP wins 316/465 seats — first single-party supermajority since WWII.', summary: 'First female PM wins historic landslide, pledging constitutional revision and stronger defense posture.',
    parties: [
      ...
      { name: 'Japan Innovation Party (Ishin)', seats: 'Coalition partner', pct: '~10%', desc: 'Center-right reformist party and the LDP\'s new coalition partner after Komeito left the coalition in October 2025 following 26 years. Advocates deregulation, constitutional revision, and decentralization. Based in Osaka.' },
      { name: 'Centrist Reform Alliance (CDP + Komeito)', seats: 'Opposition leader', pct: '~20%', desc: 'Newly merged opposition bloc formed when Komeito left the LDP coalition and joined with the Constitutional Democratic Party. Advocates pacifism, stronger social safety nets, and moderation on constitutional revision.' },
    ],
  ...
  { flag: '🇩🇪', country: 'Germany', date: 'Feb 2025', type: 'Federal Election', winner: 'Friedrich Merz - CDU/CSU (Center-Right)', result: 'CDU/CSU wins 28.5%. Grand coalition with SPD. 82.5% turnout.', summary: 'Merz becomes chancellor (May 2025). AfD surges to second place but all parties refuse to govern with them.',
    parties: [
      ...
      { name: 'AfD (Alternative for Germany)', seats: '151/630', pct: '20.8%', desc: 'Right-wing populist party. Euroskeptic, anti-immigration, calls for closer Russia ties and reduced climate spending. Surged to second place but remains excluded from coalition talks by all other parties.' },
      { name: 'SPD (Social Democrats)', seats: '121/630', pct: '16.4%', desc: 'Center-left party of outgoing Chancellor Scholz. Supports the welfare state, workers\' rights, and European integration. Enters junior coalition with CDU/CSU despite historic low result.' },
      { name: 'Greens', seats: '~75/630', pct: '~12%', desc: 'Focus on climate and social justice. Third-largest opposition party. Both BSW (Wagenknecht Alliance, ~4.97%) and FDP (~4.3%) failed to clear the 5% threshold and are not in parliament.' },
    ],
...
export const ELECTIONS = [
  ...
  { flag: '🇫🇷', country: 'France', date: 'Apr 2027', type: 'Presidential Election', stakes: 'Macron term-limited. RN frontrunner but Le Pen banned — Bardella likely candidate.',
    candidates: [
      { name: 'RN (National Rally) - Jordan Bardella', desc: 'Nationalist party likely led by Jordan Bardella after Marine Le Pen was convicted of embezzlement in March 2025 and banned from running for public office for 5 years. Bardella, the party president, is anti-immigration and Euroskeptic. Le Pen\'s appeal will be heard in summer 2026 — her candidacy depends on the outcome.' },
    ...
    watchFor: 'France\'s presidential election is the most consequential in Europe. Le Pen\'s March 2025 conviction and 5-year ban upended the race — if upheld on appeal (summer 2026), Bardella becomes the RN standard-bearer. The two-round system has historically blocked nationalist candidates in the runoff, but RN has never been stronger.' },
];
...
export const HORIZON_EVENTS = [
  { date: '2026-02-05', name: 'New START Treaty Expiration', location: 'Global', category: 'treaty', description: 'US-Russia nuclear arms treaty expires — first time since 1970s with no binding limits on strategic nuclear forces', outcome: 'Treaty expired with no replacement. Both sides retain ~1,550 deployed warheads but without mutual verification or inspection mechanisms. Arms control era effectively over.' },
  { date: '2026-02-12', name: 'Bangladesh Election — BNP Wins Landslide', location: 'Dhaka, Bangladesh', category: 'election', description: 'RESULT: BNP wins 209/297 declared seats (~59.5% turnout). Tarique Rahman to lead government. Jamaat-e-Islami (68 seats) becomes opposition. July Charter referendum passes with ~62.7% approval.', outcome: 'BNP won 209/297 declared seats in landslide (~59.5% turnout). Tarique Rahman leads new government. July Charter referendum passed ~62.7%. Jamaat-e-Islami becomes main opposition with 68 seats.' },
  { date: '2026-02-12', name: 'EU Informal Leaders Retreat', location: 'Brussels, EU', category: 'summit', description: 'EU leaders convene to discuss single market strengthening and economic competitiveness strategy', outcome: 'Leaders agreed on €150B competitiveness package and accelerated defense spending coordination. No breakthrough on enlargement timeline.' },
  { date: '2026-02-14', name: 'African Union Assembly (39th Summit)', location: 'Addis Ababa, Ethiopia', category: 'summit', description: 'Annual AU heads-of-state summit focusing on Agenda 2063 development priorities across the continent', outcome: 'Summit adopted continental free movement protocol roadmap. Called for Sudan ceasefire. Elected new AU Commission leadership.' },
  { date: '2026-03-15', name: 'France Municipal Elections (Round 1)', location: 'France', category: 'election', description: 'First round of mayoral elections across French municipalities — key indicator ahead of 2027 presidential race', outcome: 'RN doubled its first-round presence with 500+ lists surpassing 10% (vs 250 in 2020). Turnout ~56-58%. Paris: Socialist Grégoire led ~38%. Marseille razor-thin: Payan 36.7% vs RN 35%. Second round March 22.' },
  { date: '2026-03-22', name: 'France Municipal Elections (Round 2)', location: 'France', category: 'election', description: 'Final round determining new mayors in major French cities with national political implications' },
  { date: '2026-02-23', name: 'ICC Duterte Confirmation Hearing', location: 'The Hague, Netherlands', category: 'treaty', description: 'International Criminal Court hearing on charges against former Philippine President Rodrigo Duterte', outcome: 'Hearing completed Feb 23-27. Panel has 60 days to issue decision on whether to confirm charges and proceed to trial. Duterte waived right to attend in person; defense lawyers represented him.' },
  { date: '2026-03-08', name: 'Colombia Parliamentary Elections', location: 'Bogotá, Colombia', category: 'election', description: 'Election of 188 House members with primaries determining presidential candidates for May vote', outcome: 'Petro\'s Historic Pact party won and maintained congressional dominance. Opposition fragmented across multiple center-right parties. Sets stage for contested May presidential election.' },
  ...
  { date: '2028-01-01', name: 'Lebanese Parliamentary Elections (Postponed)', location: 'Beirut, Lebanon', category: 'election', description: 'Postponed by parliament vote on March 9, 2026. Mandate extended to May 2028 due to Israel-Hezbollah war aftermath and political instability. Originally scheduled for May 2026.' },
  ...
  { date: '2026-06-30', name: 'UK-EU TCA Energy & Fishing Provisions', location: 'Global', category: 'treaty', description: 'Brexit-era fishing access renewed in June 2025 agreement extending EU access for 12 more years (to 2038). Energy cooperation provisions also extended. Original expiration date retained as milestone marker.' },
  ...
  { date: '2026-10-12', name: 'IMF / World Bank Annual Meetings', location: 'Bangkok, Thailand', category: 'economic', description: 'Annual meetings (Oct 12-18) addressing global financial stability, emerging market debt, and development priorities' },
  ...
  { date: '2026-11-03', name: 'United States Midterm Elections', location: 'United States', category: 'election', description: 'All 435 House seats and 33 Class II Senate seats contested — referendum on Trump\'s second term and Congressional control' },
  { date: '2026-11-09', name: 'COP31 Climate Conference Opens', location: 'Antalya, Turkey', category: 'summit', description: 'UN Climate Change Conference under Turkey\'s presidency — negotiations on emissions targets and climate finance' },
...
export const COUNTRY_DEMONYMS = {
    ...
    'Germany': ['german', 'berlin', 'merz', 'bundestag'],
    'Ghana': ['ghanaian', 'accra'],
    'Greece': ['greek', 'athens'],
    'Grenada': ['grenadian', 'st. george\'s', 'saint george'],
