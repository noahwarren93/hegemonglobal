...
export const COUNTRIES = {
  ...
  'Venezuela': { lat: 6.42, lng: -66.59, flag: '🇻🇪', risk: 'extreme', region: 'South America', pop: '28M', gdp: '$92B', leader: 'Delcy Rodríguez (Acting)', title: 'Post-Maduro Transition',
    analysis: {
      what: 'US forces captured Maduro in January 2026, removing him to face narco-terrorism charges in New York. Delcy Rodríguez was sworn in as acting president. Military and police have pledged loyalty to the interim government. The situation remains volatile as Venezuela navigates an unprecedented political transition.',
  ...
  'Kuwait': { lat: 29.38, lng: 47.99, flag: '🇰🇼', risk: 'clear', region: 'Middle East', pop: '4.3M', gdp: '$165B', leader: 'Mishal', title: 'Oil Wealth', analysis: { what: 'Kuwait has massive oil wealth and relatively open politics for the Gulf. Parliament often clashes with government.', why: 'Oil reserves ensure continued wealth. More political freedom than Gulf neighbors.', next: 'Managing oil transition and political tensions.' }, news: [{ source: 'Kuwait Times', bias: 'center', time: '6h ago', headline: 'Budget projects oil revenue growth', url: '#' }] },
  'Bahrain': { lat: 26.23, lng: 50.59, flag: '🇧🇭', risk: 'cloudy', region: 'Middle East', pop: '1.5M', gdp: '$46B', leader: 'Hamad', title: 'Small Kingdom', analysis: { what: 'Bahrain crushed Arab Spring protests in 2011 with Saudi help. Sunni monarchy rules over Shia majority.', why: 'Sectarian tensions simmer beneath surface. US Navy Fifth Fleet headquartered here.', next: 'Managing sectarian balance and economic transition.' }, news: [{ source: 'GDN Online', bias: 'center', time: '5h ago', headline: 'Financial sector expansion continues', url: '#' }] },
