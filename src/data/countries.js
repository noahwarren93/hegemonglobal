...
export const COUNTRIES = {
  ...
  'Cape Verde': { lat: 15.12, lng: -23.61, flag: '🇨🇻', risk: 'clear', tags: [], region: 'Africa', pop: '600K', gdp: '$2.5B', leader: 'Neves', title: 'Island Democracy', analysis: { what: 'Cape Verde is one of Africa\'s most stable democracies. Tourism drives the economy.', why: 'Democratic stability is exemplary for region. Geographic isolation limits options.', next: 'Diversifying tourism-dependent economy.' } },
  ...
  'Timor-Leste': { lat: -8.87, lng: 125.73, flag: '🇹🇱', risk: 'cloudy', tags: [], region: 'Southeast Asia', pop: '1.4M', gdp: '$3B', leader: 'Ramos-Horta', title: 'Young Nation', analysis: { what: 'Asia\'s youngest nation gained independence from Indonesia in 2002 after brutal occupation.', why: 'Nation-building from trauma is ongoing. Petroleum fund management is crucial.', next: 'Preparing for post-oil economy.' } },
  ...
  'Saint Vincent and the Grenadines': { lat: 13.25, lng: -61.20, flag: '🇻🇨', risk: 'cloudy', tags: [], region: 'Caribbean', pop: '110K', gdp: '$900M', leader: 'Ralph Gonsalves', title: 'Volcanic Islands', analysis: { what: 'La Soufrière volcano erupted in 2021 causing evacuations. Tourism and agriculture drive economy.', why: 'Volcanic activity poses ongoing risk. Post-eruption recovery ongoing.', next: 'Rebuilding after volcanic eruption.' } }
};
