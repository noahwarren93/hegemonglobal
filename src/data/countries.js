...
export const COUNTRIES = {
  ...
  'Cameroon': { lat: 6.0, lng: 12.5, flag: '🇨🇲', risk: 'stormy', tags: ['Sectarian Violence', 'Political Instability'], region: 'Africa', pop: '28M', gdp: '$46B', leader: 'Biya', title: 'Anglophone Crisis', analysis: { what: 'President Biya has ruled since 1982. Anglophone regions face violent separatist conflict.', why: 'Anglophone crisis has killed thousands and displaced millions. Biya\'s age creates succession uncertainty.', next: 'Succession planning is overdue.' } },
