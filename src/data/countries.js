...
export const COUNTRIES = {
  ...
  'South Korea': { lat: 35.91, lng: 127.77, flag: '🇰🇷', risk: 'cloudy', tags: ['Political Instability'], region: 'East Asia', pop: '52M', gdp: '$1.87T', leader: 'Lee Jae-myung', title: 'Post-Crisis Recovery',
    analysis: {
  ...
  'UAE': { lat: 23.42, lng: 53.85, flag: '🇦🇪', risk: 'severe', tags: [], region: 'Middle East', pop: '10M', gdp: '$509B', leader: 'Mohamed bin Zayed', title: 'Iranian Strikes Reported',
    analysis: {
