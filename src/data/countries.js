...
export const COUNTRIES = {
  ...
  // ==================== EXTREME ====================
  'Israel': { lat: 32.8, lng: 34.8, flag: '🇮🇱', risk: 'catastrophic', tags: ['Armed Conflict', 'Territorial Dispute'], region: 'Middle East', pop: '9.5M', gdp: '$611B', leader: 'Benjamin Netanyahu', capital: 'Jerusalem (de facto)', currency: 'Israeli New Shekel (ILS)', title: 'Active War — Multi-Front Conflict',
  ...
  'Taiwan': { lat: 23.70, lng: 120.96, flag: '🇹🇼', risk: 'extreme', tags: ['Territorial Dispute'], region: 'East Asia', pop: '24M', gdp: '$884B', leader: 'Lai Ching-te', capital: 'Taipei', currency: 'New Taiwan Dollar (TWD)', title: 'Cross-Strait Tensions',
    analysis: {
  ...
  'Pakistan': { lat: 30.38, lng: 69.35, flag: '🇵🇰', risk: 'catastrophic', tags: ['Armed Conflict', 'Terrorism/Insurgency', 'Nuclear State'], region: 'South Asia', pop: '255M', gdp: '$411B', leader: 'Shehbaz Sharif', capital: 'Islamabad', currency: 'Pakistani Rupee (PKR)', title: 'Active War — Afghanistan Conflict',
  ...
  // STORMY COUNTRIES
  'United States': { lat: 37.09, lng: -95.71, flag: '🇺🇸', risk: 'stormy', tags: ['Political Instability'], region: 'North America', pop: '335M', gdp: '$30.6T', leader: 'Donald Trump', capital: 'Washington, D.C.', currency: 'US Dollar (USD)', title: 'Active Military Strikes on Iran & Extreme Political Polarization',
  ...
  'Brazil': { lat: -14.24, lng: -51.93, flag: '🇧🇷', risk: 'clear', tags: ['Political Instability'], region: 'South America', pop: '215M', gdp: '$2.26T', leader: 'Lula da Silva', capital: 'Brasilia', currency: 'Brazilian Real (BRL)', title: 'Amazon & Politics',
    analysis: {
  ...
  'Saudi Arabia': { lat: 23.89, lng: 45.08, flag: '🇸🇦', risk: 'severe', tags: ['Authoritarian Crackdown'], region: 'Middle East', pop: '36M', gdp: '$1.27T', leader: 'Mohammed bin Salman', capital: 'Riyadh', currency: 'Saudi Riyal (SAR)', title: 'Under Iranian Retaliatory Strike',
    analysis: {
  ...
  'Peru': { lat: -9.19, lng: -75.02, flag: '🇵🇪', risk: 'stormy', tags: [], region: 'South America', pop: '34M', gdp: '$318B', leader: 'José María Balcázar (Interim)', capital: 'Lima', currency: 'Peruvian Sol (PEN)', title: 'Political Instability',
    analysis: {
  ...
  'Guyana': { lat: 4.86, lng: -58.93, flag: '🇬🇾', risk: 'stormy', tags: [], region: 'South America', pop: '0.8M', gdp: '$15B', leader: 'Irfaan Ali', capital: 'Georgetown', currency: 'Guyanese Dollar (GYD)', title: 'Oil Boom',
    analysis: {
  ...
  'UAE': { lat: 23.42, lng: 53.85, flag: '🇦🇪', risk: 'severe', tags: [], region: 'Middle East', pop: '10M', gdp: '$509B', leader: 'Mohamed bin Zayed Al Nahyan', capital: 'Abu Dhabi', currency: 'UAE Dirham (AED)', title: 'Iranian Strikes Reported',
    analysis: {
  ...
  'Greenland': { lat: 71.71, lng: -42.60, flag: '🇬🇱', risk: 'stormy', tags: [], region: 'Arctic / North Atlantic', pop: '57K', gdp: '$3.1B', leader: 'Múte B. Egede', capital: 'Nuuk', currency: 'Danish Krone (DKK)', title: 'Arctic Sovereignty Dispute',
    analysis: {
  ...
  'Kosovo': { lat: 42.57, lng: 20.90, flag: '🇽🇰', risk: 'stormy', tags: [], region: 'Europe', pop: '1.8M', gdp: '$10B', leader: 'Vjosa Osmani', capital: 'Pristina', currency: 'Euro (EUR)', title: 'Disputed Territory', analysis: { what: 'Kosovo declared independence from Serbia in 2008 but is not universally recognized. Tensions with Serbia remain high.', why: 'Serbia-Kosovo tensions risk regional instability. Recognition dispute affects international participation.', next: 'Normalizing Serbia relations remains key.' } },
