...
export const HORIZON_EVENTS = [
  ...
  { date: '2026-02-12', name: 'Bangladesh Election — BNP Wins Landslide', location: 'Dhaka, Bangladesh', category: 'election', description: 'RESULT: BNP wins ~211/299 seats. Tarique Rahman to lead government. Jamaat-e-Islami (~70 seats) becomes opposition. July Charter referendum passes with 72.9% approval.', outcome: 'BNP won ~211/299 seats in landslide. Tarique Rahman leads new government. July Charter referendum passed 72.9%. Jamaat-e-Islami becomes main opposition with ~70 seats.' },
  ...
  { date: '2026-03-15', name: 'France Municipal Elections (Round 1)', location: 'France', category: 'election', description: 'First round of mayoral elections across French municipalities — key indicator ahead of 2027 presidential race' },
