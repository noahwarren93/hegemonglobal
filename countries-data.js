...
const COUNTRIES = {
  ...
  'Sudan': { lat: 12.86, lng: 30.22, flag: '🇸🇩', risk: 'catastrophic', region: 'Africa', pop: '46M', gdp: '$34B', leader: 'Disputed', title: 'Civil War',
    analysis: {
      what: 'Civil war erupted in April 2023 between the Sudanese Armed Forces (SAF) led by General al-Burhan and the paramilitary Rapid Support Forces (RSF) led by Hemedti. Fighting has devastated Khartoum and spread across the country, particularly in Darfur where ethnic violence has resurged. Over 15,000 people have been killed and 10+ million displaced—the world\'s largest displacement crisis. Mass killings, sexual violence, and ethnic cleansing have been documented. Famine conditions are spreading with hospitals non-functional.',
  ...
  'Haiti': { lat: 18.97, lng: -72.29, flag: '🇭🇹', risk: 'catastrophic', region: 'Caribbean', pop: '11.6M', gdp: '$20B', leader: 'Transitional Council', title: 'Gang Violence Crisis',
    analysis: {
      what: 'Haiti has collapsed into gang rule following the 2021 assassination of President Moïse. Armed gangs now control 80% of Port-au-Prince, the capital. Gang violence has killed thousands and displaced over 700,000 people. The state has effectively ceased to function—hospitals are closed, schools shuttered, and police overwhelmed. A Kenya-led multinational security mission began deploying in 2024 but faces enormous challenges. A transitional council governs with little actual power.',
  ...
  'Afghanistan': { lat: 33.94, lng: 67.71, flag: '🇦🇫', risk: 'catastrophic', region: 'Central Asia', pop: '41M', gdp: '$14B', leader: 'Taliban', title: 'Humanitarian Crisis',
    analysis: {
  ...
  'DRC': { lat: -4.04, lng: 21.76, flag: '🇨🇩', risk: 'catastrophic', region: 'Africa', pop: '99M', gdp: '$65B', leader: 'Félix Tshisekedi', title: 'Eastern Conflict',
    analysis: {
  ...
  'Somalia': { lat: 5.15, lng: 46.20, flag: '🇸🇴', risk: 'catastrophic', region: 'Africa', pop: '18M', gdp: '$8B', leader: 'Hassan Sheikh Mohamud', title: 'Al-Shabaab Threat',
    analysis: {
  ...
  'Syria': { lat: 34.80, lng: 38.99, flag: '🇸🇾', risk: 'extreme', region: 'Middle East', pop: '22M', gdp: '$9B', leader: 'Bashar al-Assad', title: 'Fragmented State',
    analysis: {
  ...
  // ==================== SEVERE ====================
  'China': { lat: 35.86, lng: 104.20, flag: '🇨🇳', risk: 'severe', region: 'East Asia', pop: '1.4B', gdp: '$17.7T', leader: 'Xi Jinping', title: 'Economic Slowdown',
    analysis: {
  ...
  'Venezuela': { lat: 6.42, lng: -66.59, flag: '🇻🇪', risk: 'severe', region: 'South America', pop: '28M', gdp: '$92B', leader: 'Nicolás Maduro', title: 'Political Crisis',
    analysis: {
      what: 'The July 2024 presidential election was widely seen as stolen by Maduro despite opposition candidate González\'s apparent victory. Protests were violently suppressed with thousands arrested. González fled to Spain. The opposition holds evidence of fraud but international pressure has failed. Over 7 million Venezuelans have fled the country—the largest displacement in Western Hemisphere history. The economy has shrunk 75% since 2013.',
      why: 'Venezuela has the world\'s largest proven oil reserves but produces a fraction of potential output. The migration crisis strains neighboring countries, especially Colombia. It\'s a test case for whether authoritarian consolidation can be reversed. Russian and Chinese support props up the regime. Regional democracy norms are weakened.',
      next: 'Maduro appears secure despite illegitimacy. Watch for: sanctions pressure, opposition strategy, oil production changes, and migration flows. Without elite defection or external intervention, the regime will persist.'
    },
    news: [
  ...
  // STORMY COUNTRIES
  'United States': { lat: 37.09, lng: -95.71, flag: '🇺🇸', risk: 'stormy', region: 'North America', pop: '335M', gdp: '$25.5T', leader: 'Current Admin', title: 'Political Polarization',
    analysis: {
  ...
  'Brazil': { lat: -14.24, lng: -51.93, flag: '🇧🇷', risk: 'stormy', region: 'South America', pop: '215M', gdp: '$1.9T', leader: 'Lula da Silva', title: 'Amazon & Politics',
    analysis: {
  ...
  'India': { lat: 20.59, lng: 78.96, flag: '🇮🇳', risk: 'stormy', region: 'South Asia', pop: '1.4B', gdp: '$3.4T', leader: 'Narendra Modi', title: 'Rising Power',
    analysis: {
  ...
  'Saudi Arabia': { lat: 23.89, lng: 45.08, flag: '🇸🇦', risk: 'stormy', region: 'Middle East', pop: '36M', gdp: '$1.1T', leader: 'MBS', title: 'Vision 2030',
    analysis: {
      ...
      why: 'Saudi Arabia is the world\'s swing oil producer, able to influence global prices. It controls Islam\'s holiest sites. MBS\'s regional policies—Yemen war, Qatar blockade (now ended), Abraham Accords negotiations—reshape the Middle East. The kingdom\'s sovereign wealth fund is one of the world\'s largest, acquiring global assets.',
  ...
  'Bolivia': { lat: -16.29, lng: -63.59, flag: '🇧🇴', risk: 'stormy', region: 'South America', pop: '12M', gdp: '$44B', leader: 'Luis Arce', title: 'Political Divisions',
    analysis: {
  ...
  'Japan': { lat: 36.20, lng: 138.25, flag: '🇯🇵', risk: 'clear', region: 'East Asia', pop: '125M', gdp: '$4.2T', leader: 'Shigeru Ishiba', title: 'Defense Buildup',
    analysis: {
  ...
  'Chile': { lat: -35.68, lng: -71.54, flag: '🇨🇱', risk: 'cloudy', region: 'South America', pop: '19M', gdp: '$301B', leader: 'Gabriel Boric', title: 'Constitutional Reform',
    analysis: {
